...
import com.syahrizal.submission2daftarfilm.databinding.FragmentDetailTvShowBinding
import com.syahrizal.submission2daftarfilm.viewmodel.DetailTVShowViewModel
    ...
    private fun populateDetailMovie(detailTVShowEntity: DetailTVShowEntity) {
        fragmentDetailTvShowBinding.apply {
            ...
            productionCompaniesData =
                if (detailTVShowEntity.productionCompanies.isNullOrBlank()) "-"
